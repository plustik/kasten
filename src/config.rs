...
impl Config {
    pub fn new() -> Self {
        ...
        let db_location = env::var("KASTEN_DB_LOCATION").unwrap_or_else(|_| String::from(DATABASE_LOCATION));
        let file_location = env::var("KASTEN_FILE_LOCATION").unwrap_or_else(|_| String::from(FILE_LOCATION));
        let static_files = env::var("KASTEN_STATIC_FILES").unwrap_or_else(|_| String::from(STATIC_FILES));
        Config {
